...
const PKGINFOS = Dict([
  ...
  "DelaunayTriangulation" => PkgInfo(pkgname="DelaunayTriangulation", username="DanielVandH", branch="master"),
  "VoronoiDelaunay" => PkgInfo(pkgname="VoronoiDelaunay", username="JuliaGeometry", branch="master"),
  "VoronoiCells" => PkgInfo(pkgname="VoronoiCells", username="JuliaGeometry", branch="master"),
  "Delaunay" => PkgInfo(pkgname="Delaunay", username="eschnett", branch="master", codecovlink=nothing),
  "MiniQhull" => PkgInfo(pkgname="MiniQhull", username="gridap", branch="master"),
  "DirectQhull" => PkgInfo(pkgname="DirectQhull", username="JuhaHeiskala", branch="master", codecovlink=nothing),
  ...
  "Triangle" => PkgInfo(pkgname="Triangle", username="cvdlab", branch="master"),
