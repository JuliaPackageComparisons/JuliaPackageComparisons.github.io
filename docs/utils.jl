...
const PKGINFOS = [
    ...
    PkgInfo(pkgname="GMT", username="GenericMappingTools", branch="master", docslink="https://www.generic-mapping-tools.org/GMTjl_doc/"),
    ...
    PkgInfo(pkgname="InMemoryDatasets", username="sl-solution", branch="master", docslink="https://sl-solution.github.io/InMemoryDatasets.jl/stable/"),
    ...
    PkgInfo(pkgname="CBinding", username="analytech-solutions", branch="master", docslink=nothing),
    ...
    PkgInfo(pkgname="RedPitayaDAQServer", username="tknopp", branch="master", repolink="https://github.com/tknopp/RedPitayaDAQServer", docslink="https://tknopp.github.io/RedPitayaDAQServer/dev/"),
