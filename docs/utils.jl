...
const PKGINFOS = Dict([
  ...
  "MixedStructTypes" => PkgInfo(pkgname="MixedStructTypes", username="JuliaDynamics"),
  "SumTypes" => PkgInfo(pkgname="SumTypes", username="MasonProtter", branch="master"),
  "Unityper" => PkgInfo(pkgname="Unityper", username="YingboMa", branch="master"),
  "Expronicon" => PkgInfo(pkgname="Expronicon", username="Roger-luo"),
